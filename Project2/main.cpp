...
int main()
{
	...
	***************************************************************************************/
	int detector = Orb;
	bool matching = BF;
	float filter_match_distance = 0.8;
	...
	FILE* fp;
	fopen_s(&fp, "../output/trajectory_orb_8_08.txt", "w");
...
void tutorial(Methods method)
{
	...
	***********************************************************************************/
	...
	/***********************************************************************************
		...
		the right camera.
	***********************************************************************************/
	Mat first_img_left = imread("../dataset/sequences/00/image_0/000353.png", IMREAD_GRAYSCALE);
	Mat first_img_right = imread("../dataset/sequences/00/image_1/000353.png", IMREAD_GRAYSCALE);
	...
	***********************************************************************************/
	...
	Mat second_img_left = imread("../dataset/sequences/00/image_0/000354.png", IMREAD_GRAYSCALE);
	...
	***********************************************************************************/
	vector<vector<DMatch>> matches = method.match_features(des0, des1, BF, Orb, false, 2);
	...
	***********************************************************************************/
	matches = method.filter_matches_distance(matches, 0.6);
